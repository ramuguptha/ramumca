...
try
{
	...
	while(rs.next()) 
	{
		...
		out.println("<td>"+"<a class='btn btn-danger' href='deletevenderdata.jsp?Id="+rs.getInt(1)+"'>Delete</a>"+"</td>");
		out.println("<td>"+"<a class='btn btn-primary' href='acceptvenderdata.jsp?Id="+rs.getInt(1)+"'>Accept</a>"+"</td>");
		out.println("</tr>");
		}
		else
		{
		...
		out.println("<td>"+"<a class='btn btn-danger' href='deletevenderdata.jsp?Id="+rs.getInt(1)+"'>Delete</a>"+"</td>");
		out.println("<td>"+"<a class='btn btn-primary' href='rejectvenderdata.jsp?Id="+rs.getInt(1)+"'>Reject</a>"+"</td>");
		out.println("</tr>");
		}
	}
	out.println("</table>");
