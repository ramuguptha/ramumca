...
try
{
	PreparedStatement ps=con.prepareStatement("select * from vender where email='"+email+"'");
	...
	while(rs.next()) 
	{
		...
		out.println("<td>"+"<a class='btn btn-primary' href='updatevenderpage.jsp?Id="+rs.getInt(1)+"'>Update</a>"+"</td>");
